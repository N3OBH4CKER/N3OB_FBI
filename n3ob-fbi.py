...
try:
	...
	print R + 'N3OB_'.center(44)
	print "H4CKER".center(44)
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'N3OB' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'N3OB' + W +'/' + R +'Bot ' + W + '>> ')
